...
module.exports = {
  up: async (queryInterface, Sequelize) => {
     await queryInterface.bulkInsert('Workouts', [
      ...
      {
        name: "Fran",
        link: "https://www.youtube.com/watch?v=RGPm3QiA3sI&ab_channel=TabataSongs",
        description: "21-15-9 for time of thrusters and pull-ups. RX weight: M-95, W-75",
      },
      {
        name: "Grace",
        link: "https://www.youtube.com/watch?v=IWHhThVqMhU&ab_channel=WODwell",
        description: "30 clean-and-jerks for time. RX weight: M-135, W-95",
      },
      {
        name: "Gwen",
        link: "https://www.youtube.com/watch?v=GrTdasUVpSw&ab_channel=CrossFit%C2%AE",
        description: "15-12-9 reps for load of clean-and-jerks (unbroken). Rest as needed between sets.",
      },
      {
        name: "Helen",
        link: "https://www.youtube.com/watch?v=-Y4_0QtOTv4&ab_channel=CrossFitGames",
        description: "3 rounds for time of 400m run, 21 kettlebell swings, 12 pull-ups. RX weight: M-50, W-35",
      },
      {
        name: "Hope",
        link: "https://www.youtube.com/watch?v=jYtAtTDwsnM&ab_channel=CrossFit%C2%AE",
